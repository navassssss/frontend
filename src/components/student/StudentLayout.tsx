...
export default function StudentLayout({ children, title, showBack = false, actions }: StudentLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-[#f6f9f8] font-sans">
            ...
            {/* ── Top Header ── */}
            <header className="fixed top-0 left-0 right-0 bg-white border-b border-slate-100 z-40 shadow-sm">
                ...
                {/* Desktop header */}
                <div className="hidden lg:flex h-[68px] px-6 lg:px-8 items-center justify-between w-full">
                    {/* Logo section */}
            ...
            <div className="flex pt-[72px] lg:pt-[68px]">
                {/* ── Desktop Sidebar ── */}
                <aside className="hidden lg:flex w-[260px] bg-white border-r border-slate-100 fixed top-[68px] bottom-0 flex-col z-30">
                    {/* Nav */}
                ...
                {/* ── Main content ── */}
                <main className="flex-1 min-w-0 lg:pl-[260px] w-full">
                    <div className="px-4 md:px-8 pt-6 pb-24 md:pb-8 w-full">
                        {/* Desktop Page Header */}
                        <div className="hidden lg:flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-[26px] font-black text-slate-800 tracking-tight">{title}</h1>
                            </div>
