    ...
    <AppLayout title="Medical">
      <div className="p-4 md:p-10 max-w-[1280px] mx-auto pb-28 space-y-8 bg-slate-50/30 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 animate-slide-up">
          {/* Active Card */}
          <div className="rounded-[1.5rem] p-5 flex items-center gap-5 bg-rose-100/80 w-full relative overflow-hidden transition-all hover:bg-rose-100 group">
            <div className="bg-rose-200/60 rounded-xl p-3 shrink-0 text-rose-700 transition-colors group-hover:bg-rose-200">
              <Briefcase className="w-6 h-6" />
            </div>
            <div className="flex flex-col">
              <span className="text-4xl font-black text-rose-800 tracking-tight">{active.length.toString().padStart(2, '0')}</span>
              <span className="text-[11px] font-black uppercase tracking-widest text-rose-600">Active</span>
            </div>
          </div>
          ...
          <div className="rounded-[1.5rem] p-5 flex items-center gap-5 bg-emerald-100/80 w-full relative overflow-hidden transition-all hover:bg-emerald-100 group">
            ...
            <div className="flex flex-col">
              <span className="text-4xl font-black text-emerald-900 tracking-tight">{(history.filter(h => h.status === 'recovered').length).toString().padStart(2, '0')}</span>
              <span className="text-[11px] font-black uppercase tracking-widest text-[#00865B]">Recovered</span>
            </div>
          </div>
          ...
          <div className="rounded-[1.5rem] p-5 flex items-center gap-5 bg-[#ebf3ff]/80 w-full relative overflow-hidden transition-all hover:bg-[#ebf3ff] group">
            ...
            <div className="flex flex-col">
              <span className="text-4xl font-black text-blue-900 tracking-tight">{(history.filter(h => h.status === 'sent_home').length).toString().padStart(2, '0')}</span>
              <span className="text-[11px] font-black uppercase tracking-widest text-blue-600">Sent Home</span>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-md max-h-[85vh] overflow-hidden flex flex-col bg-white rounded-3xl shadow-2xl animate-scale-in">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Illness / Condition</label>
                <Input
                  id="illness-name"
                  list="common-illnesses"
                  placeholder="Search or enter illness..."
                  value={illnessName}
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Time Reported</label>
                <Input
                  id="reported-at"
                  type="datetime-local"
                  value={reportedAt}
