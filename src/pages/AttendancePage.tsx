            ...
            <div className="p-4 space-y-6 lg:p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center justify-center bg-card border border-border rounded-xl p-1 shadow-sm mx-auto md:mx-0 w-fit">
                        <Button variant="ghost" size="icon" onClick={() => changeDate(-1)} className="h-9 w-9 shrink-0">
                            <ChevronLeft className="w-5 h-5" />
                        </Button>
                        <div className="flex items-center justify-center gap-2 px-2 sm:px-4 border-x border-border mx-1 min-w-[130px]">
                            <CalendarIcon className="w-4 h-4 text-primary shrink-0" />
                            <input
                                type="date"
                                value={selectedDate}
                                onChange={(e) => setSelectedDate(e.target.value)}
                                className="bg-transparent border-none focus:ring-0 text-sm font-medium w-auto cursor-pointer p-0"
                            />
                        </div>
                        <Button variant="ghost" size="icon" onClick={() => changeDate(1)} className="h-9 w-9 shrink-0">
                ...
                {/* Class Status Overview - Moved to Top */}
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2">
                                    {classStatuses.map((cls) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <span className="text-xs font-bold truncate pr-1">{cls.name}</span>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 self-start sm:self-auto bg-muted/30 p-1 rounded-lg border border-border">
                            ...
                            <Button
                                ...
                                className="h-8 rounded-md"
                            >
                                <Sunset className="w-3.5 h-3.5 mr-1.5" /> Afternoon
                            </Button>
                        </div>
                    </div>
