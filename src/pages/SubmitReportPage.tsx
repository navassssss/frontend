      ...
      <main className="p-4 max-w-lg mx-auto pb-24">
        <form onSubmit={handleSubmit} className="space-y-5 animate-fade-in">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">Select Duty *</label>
            {isLoading ? (
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-32 px-4 py-3 rounded-xl border border-input bg-card text-base resize-none transition-all duration-200 placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
          </div>
